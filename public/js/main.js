(function($) {
    ...
    */
    ...
    $('#button_more').click(function () { $.scrollTo('#features_2',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});
    $('#features2Prev').click(function () { $.scrollTo('0px',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});

    $('#aboutPrev').click(function () { $.scrollTo('#about',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});
    $('#aboutNext').click(function () { $.scrollTo('#prezi',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});
    $('#features1Next').click(function () { $.scrollTo('#gallery',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});
    $('#features1Prev').click(function () { $.scrollTo('#features_1',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});
    $('#features2Next').click(function () { $.scrollTo('#features_1',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});
    // $('#aboutPrev').click(function () { $.scrollTo('#features_2',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});

    $('#galleryNext').click(function () { $.scrollTo('#about',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});
    $('#galleryPrev').click(function () { $.scrollTo('#gallery',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});
    $('#preziNext').click(function () { $.scrollTo('#features_3',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});
    $('#preziPrev').click(function () { $.scrollTo('#prezi',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});

    $('#preziNext').click(function () { $.scrollTo('#features_3',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});
    $('#preziPrev').click(function () { $.scrollTo('#prezi',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});
    $('#go_to_top').click(function () { $.scrollTo('0px',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});
    },
    ...
    */
    Animations: function() {
        $('#about').waypoint(function() {
            ...
            setTimeout(function(){$('#service_6').addClass('animated fadeInDown')},300);
            setTimeout(function(){$('#service_5').addClass('animated fadeInDown')},500);
            setTimeout(function(){$('#service_4').addClass('animated fadeInDown')},700);
        }, { offset: '50%' });
